...
export class user_register
{
    ...
    public async register (requset: Request, response: Response, nextfunction: NextFunction): Promise<register_message>
    {
    ...
    @verification()
    public async telephone_register(requset: Request, response: Response, nextfunction: NextFunction): Promise<register_message>
    {
    }
}