...
export function listen(httpApp: any, socketServer: any, options: any, listenCallback: any): void;

export function on(event: any, listener: any): void;

export function removeAllListeners(event: any): void;

export function setOption(optionName: any, optionValue: any): any;
...
export namespace events {
    ...
    function setDefaultListener(eventName: any): void;
...
export namespace util {
    ...
    function log(level: any, logText: any, logFields: any): void;

    function logDebug(logText: any, logFields: any): void;

    function logError(logText: any, logFields: any): void;

    function logInfo(logText: any, logFields: any): void;

    function logWarning(logText: any, logFields: any): void;
